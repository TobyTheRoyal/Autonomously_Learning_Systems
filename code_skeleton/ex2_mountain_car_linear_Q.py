...
model = nn.Linear(in_features=num_observations, out_features=num_actions)
#print(model)
...
for it in range(max_train_iterations):
  episode_metrics = run_episode(is_training=True, is_rendering=(it % 100 == 0))
